...
10-19, 20-25 and 32-33 to the additive micro/macro structure, Eqs. (9),
(17), (18), applicability limits, nomenclature, tables and graphical `F/S`
functions. The release decision remains `candidate_only` because the `F/S`
curves still require digitization or authoritative tabulation, formula OCR
requires manual verification, SI mapping is incomplete and no reference HTC
...
- Первым приоритетом является `HTC-CHEN-1962-SOURCE-CANDIDATE`, потому что
  ...
  уравнений, digitized `F/S` functions, области применимости и численных
  reference-тестов.
