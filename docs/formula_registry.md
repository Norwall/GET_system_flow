...
- Математическая запись: runtime correlation is still not released. Local audit of Chen 1962 pages 4, 6, 10-19, 20-25 and 32-35 is recorded in `docs/chen_1962_formula_audit_2026-07-06.md` and `docs/chen_1962_reference_value_audit_2026-07-08.md`; applicability and project-geometry scope are recorded in `docs/chen_1962_scope_audit_2026-07-08.md`. The candidate structure is additive: total HTC is the sum of micro-convective and macro-convective contributions. Rendered scan pages verify Eq. (9) as `h_mac = 0.023 * Re_L^0.8 * Pr_L^0.4 * k_L/D * F`, Eq. (17) as `h_mic = 0.00122 * (k_L^0.79 * Cp_L^0.45 * rho_L^0.49 * g_c^0.25) / (sigma^0.5 * mu_L^0.29 * lambda^0.24 * rho_v^0.24) * DeltaT^0.24 * DeltaP^0.75 * S`, and Eq. (18) as `h = h_mic + h_mac`. `F` depends on the Martinelli parameter and `S` on local two-phase Reynolds number. The report gives `F` and `S` graphically in Figures 7 and 8; candidate graph digitization is recorded in `docs/chen_1962_graph_digitization_2026-07-07.md`, a rendered graph review is recorded in `docs/chen_1962_graph_review_2026-07-08.md`, candidate source-unit to SI mapping plus code-level hand-calculation/dimensionless-axis helpers are recorded in `docs/chen_1962_si_mapping_2026-07-07.md`, direct Eqs. (9)/(17)/(18) and graph-to-SI arithmetic fixtures are recorded in `docs/chen_1962_hand_calculation_2026-07-08.md`, Tables I/II condition/deviation context is transcribed in `docs/chen_1962_validation_tables_2026-07-07.md`, and the reference-value audit found no printed pointwise HTC values in the audited report pages. Numeric runtime use still requires accepting the graph uncertainty or obtaining an authoritative table plus accepted hand-calculation or external primary-source reference tests, and any released adapter must be vertical-heated-flow only; the current horizontal evaporator is unsupported by the Chen source.
- Переменные и размерности: expected future saturated flow-boiling HTC inputs include heat flux, mass flux, quality, diameter, saturated liquid/vapor properties, wall/saturation temperature difference and pressure/superheat definitions. Candidate SI mapping is implemented only in `boiling_heat_transfer.chen_1962_candidate_heat_transfer_coefficient_si` as a direct helper; Fig. 7/8 axis mappings are candidate-only helpers `boiling_heat_transfer.chen_1962_candidate_inverse_martinelli_parameter` and `boiling_heat_transfer.chen_1962_candidate_two_phase_reynolds`; the candidate end-to-end graph-to-SI composition helper is `boiling_heat_transfer.chen_1962_candidate_flow_boiling_heat_transfer_coefficient_si`. Candidate `F`/`S` helpers reject extrapolation outside the rendered Fig. 7/Fig. 8 ranges, and the graph-to-SI helper rejects vapor quality outside Chen's approximate `0.01 <= x <= 0.70` scope, but none are released as selectable runtime code.
- Область применимости: Chen page 6 limits the source to saturated two-phase non-metallic fluids in vertical axial, stable convective flow without slug flow, liquid deficiency, or critical heat flux; pages 18-19 summarize annular/annular-mist use and an approximate 1-70% vapor-quality range. `docs/chen_1962_scope_audit_2026-07-08.md` fixes this as a vertical-heated-flow-only maximum release scope with source quality guard `0.01 <= x <= 0.70`; the current horizontal evaporator is unsupported. Current diagnostic/source-candidate branch `heat_transfer_model="chen_1962_source_candidate"` computes no HTC, dryout, or CHF.
- Источник: J. C. Chen, A correlation for boiling heat transfer to saturated fluids in convective flow, OSTI ID 4636495, DOI `10.2172/4636495`, <https://www.osti.gov/biblio/4636495>, full-text <https://www.osti.gov/servlets/purl/4636495>; local candidate `sources/primary/chen_1962_osti_4636495.pdf`, SHA256 `5DDE91B1FE38B2CE6E4977AEE2A25A61BBEDC83C5A7214802496754E4989017E`; `docs/chen_1962_formula_audit_2026-07-06.md`; `docs/chen_1962_graph_digitization_2026-07-07.md`; `docs/chen_1962_graph_review_2026-07-08.md`; `docs/chen_1962_si_mapping_2026-07-07.md`; `docs/chen_1962_validation_tables_2026-07-07.md`; `docs/chen_1962_reference_value_audit_2026-07-08.md`; `docs/chen_1962_scope_audit_2026-07-08.md`; `docs/chen_1962_hand_calculation_2026-07-08.md`; `docs/source_gate_manifest.json`; `docs/source_audit_open_web_2026-07-05.md`; `docs/source_audit_followup_2026-07-06.md`; `docs/primary_source_inventory.md`.
- Код: `boiling_heat_transfer.chen_1962_audit_record`; `boiling_heat_transfer.chen_1962_source_candidate`; `boiling_heat_transfer.chen_1962_candidate_f_factor`; `boiling_heat_transfer.chen_1962_candidate_suppression_factor`; `boiling_heat_transfer.chen_1962_candidate_heat_transfer_coefficient_si`; `boiling_heat_transfer.chen_1962_candidate_flow_boiling_heat_transfer_coefficient_si`; `boiling_heat_transfer.diagnose_prescribed_heat_input`.
...
- Dissertation audit candidate: Moreno Quiben TH3337 pages 53-66 and 109-125 are mapped in `docs/dissertation_formula_audit_2026-07-06.md`; this is `candidate_only` evidence and does not release the MSH source gate. The TH3337 text layer gives candidate Eqs. (4.53)-(4.56): `(dp/dz)_frict = F*(1-x)^(1/3) + B*x^3`, `F = A + 2*(B-A)*x`, `A = (dp/dz)_L0`, and `B = (dp/dz)_G0`. The same dissertation flow-pattern pressure-drop chapter gives annular branch Eq. (7.4)/(7.5), stratified-wavy branch Eq. (7.9)-(7.11), slug/intermittent branch Eq. (7.6)/(7.12), mist branch Eq. (7.13)-(7.17), and dryout pressure-drop interpolation Eq. (7.18), now locked separately in `docs/moreno_quiben_th3337_annular_pressure_drop_audit_2026-07-07.md`, `docs/moreno_quiben_th3337_stratified_wavy_pressure_drop_audit_2026-07-08.md`, `docs/moreno_quiben_th3337_slug_pressure_drop_audit_2026-07-07.md`, `docs/moreno_quiben_th3337_mist_pressure_drop_audit_2026-07-07.md`, and `docs/moreno_quiben_th3337_dryout_pressure_drop_audit_2026-07-07.md`.
...
- Код: `published_friction.muller_steinhagen_heck_1986_pressure_gradient_pa_per_m` — защитная заглушка, которая выбрасывает `SourceRequiredCorrelationError`; `published_friction.muller_steinhagen_heck_th3337_candidate_pressure_gradient_pa_per_m` — candidate-only transcription helper from TH3337 Eqs. (4.53)-(4.56), not a released runtime model; `published_friction.moreno_quiben_th3337_candidate_annular_pressure_gradient_pa_per_m`, `published_friction.moreno_quiben_th3337_candidate_stratified_wavy_pressure_gradient_pa_per_m`, `published_friction.moreno_quiben_th3337_candidate_slug_interpolated_pressure_gradient_pa_per_m`, `published_friction.moreno_quiben_th3337_candidate_mist_pressure_gradient_pa_per_m`, and `published_friction.moreno_quiben_th3337_candidate_dryout_interpolated_pressure_gradient_pa_per_m` — candidate-only flow-pattern branch helpers from TH3337 Eq. (7.4)/(7.5), Eq. (7.9)-(7.11), Eq. (7.6)/(7.12), Eq. (7.13)-(7.17), and Eq. (7.18), also not released runtime models.
- Тесты: `tests/test_two_phase_pressure_drop.py`; `tests/test_formula_registry.py`.

## TP-FRIEDEL-1979-SOURCE-GATE

- Dissertation audit candidate: Moreno Quiben TH3337 pages 64-65, 119-125 and 146 are mapped in `docs/dissertation_formula_audit_2026-07-06.md`; this is `candidate_only` evidence and does not release the Friedel source gate. The TH3337 text layer gives candidate Eqs. (4.40)-(4.47): `Delta p_frict = Delta p_L0 * phi_f0^2`, `phi_f0^2 = E + 3.24*F*H/(Fr_H^0.045*We_L^0.035)`, and definitions for `Fr_H`, `E`, `F`, `H`, `We_L`, and `rho_h`. The annular, stratified-wavy, slug/intermittent, mist and dryout pressure-drop branches of Moreno Quiben's own model are documented separately in `docs/moreno_quiben_th3337_annular_pressure_drop_audit_2026-07-07.md`, `docs/moreno_quiben_th3337_stratified_wavy_pressure_drop_audit_2026-07-08.md`, `docs/moreno_quiben_th3337_slug_pressure_drop_audit_2026-07-07.md`, `docs/moreno_quiben_th3337_mist_pressure_drop_audit_2026-07-07.md`, and `docs/moreno_quiben_th3337_dryout_pressure_drop_audit_2026-07-07.md`; they remain candidate-only guidance.
- Статус: SOURCE_REQUIRED.
...
- Код: `published_friction.friedel_1979_pressure_gradient_pa_per_m` — защитная заглушка, которая выбрасывает `SourceRequiredCorrelationError`; `published_friction.friedel_th3337_candidate_two_phase_multiplier` and `published_friction.friedel_th3337_candidate_pressure_gradient_pa_per_m` — candidate-only transcription helpers from TH3337 Eqs. (4.40)-(4.47), not released runtime models.
- Тесты: `tests/test_two_phase_pressure_drop.py`; `tests/test_formula_registry.py`.
...
- Dissertation audit candidate: Wojtan TH2978 is recorded in `docs/dissertation_formula_audit_2026-07-06.md`; page 1 confirms the thesis, `docs/wojtan_th2978_text_layer_audit_2026-07-08.md` confirms figure-level dryout/heat-transfer labels around pages 172-183, and `docs/wojtan_th2978_rendered_dryout_audit_2026-07-08.md` locks rendered dryout-limit Eqs. (7.47)-(7.48) as candidate-only. Section 7.4.3 Eq. (7.49), the wider map-transition criteria and Part II HTC equations still require OCR/manual or rendered-page audit before any WUT release. Moreno Quiben TH3337 pressure-drop guidance, including `docs/moreno_quiben_th3337_annular_pressure_drop_audit_2026-07-07.md`, `docs/moreno_quiben_th3337_stratified_wavy_pressure_drop_audit_2026-07-08.md`, `docs/moreno_quiben_th3337_slug_pressure_drop_audit_2026-07-07.md`, `docs/moreno_quiben_th3337_mist_pressure_drop_audit_2026-07-07.md`, and `docs/moreno_quiben_th3337_dryout_pressure_drop_audit_2026-07-07.md`, helps identify WUT map dependencies but does not release Part I transition criteria.
- Статус: SOURCE_REQUIRED.
...
- Статус: SOURCE_CANDIDATE / NOT_RELEASED.
- Математическая запись: TH2978 rendered-page dryout-limit guidance is recorded only as a candidate transcription, directly from `docs/wojtan_th2978_rendered_dryout_audit_2026-07-08.md` page 183, Eqs. (7.47)-(7.48). Moreno Quiben TH3337 p. 124, Eqs. (7.19)-(7.20), as summarized in `docs/dissertation_formula_audit_2026-07-06.md` and `docs/wojtan_th3337_dryout_boundary_audit_2026-07-07.md`, corroborates the same formula family. The candidate equations are:

```math
x_{di}=0.58\exp\left(0.52-0.235We_G^{0.17}Fr_G^{0.37}\left({\rho_G\over\rho_L}\right)^{0.25}\left({q\over q_{crit}}\right)^{0.70}\right)
```

```math
x_{de}=0.61\exp\left(0.57-5.8\cdot10^{-3}We_G^{0.38}Fr_G^{0.15}\left({\rho_G\over\rho_L}\right)^{-0.09}\left({q\over q_{crit}}\right)^{0.27}\right)
```

- Переменные и размерности: `xdi` and `xde` are vapor qualities; `We_V`/`We_G` and `Fr_V`/`Fr_G` are gas/vapor-phase dimensionless groups; `rho_V/rho_L` is the vapor-to-liquid density ratio; `q/qcrit` is the heat-flux ratio used by the cited equations.
- Область применимости: audit/regression guidance for future WUT dryout/HTC work only. `docs/wojtan_th2978_rendered_dryout_audit_2026-07-08.md` covers only TH2978 Eqs. (7.47)-(7.48) as candidate dryout-quality limits; Eq. (7.49), WUT map transitions and Part II heat-transfer equations still require separate audit. The separate TH3337 annular/stratified-wavy/slug/mist/dryout pressure-drop branches in `docs/moreno_quiben_th3337_annular_pressure_drop_audit_2026-07-07.md`, `docs/moreno_quiben_th3337_stratified_wavy_pressure_drop_audit_2026-07-08.md`, `docs/moreno_quiben_th3337_slug_pressure_drop_audit_2026-07-07.md`, `docs/moreno_quiben_th3337_mist_pressure_drop_audit_2026-07-07.md`, `docs/moreno_quiben_th3337_dryout_pressure_drop_audit_2026-07-07.md`, `published_friction.moreno_quiben_th3337_candidate_annular_pressure_gradient_pa_per_m`, `published_friction.moreno_quiben_th3337_candidate_stratified_wavy_pressure_gradient_pa_per_m`, `published_friction.moreno_quiben_th3337_candidate_slug_interpolated_pressure_gradient_pa_per_m`, `published_friction.moreno_quiben_th3337_candidate_mist_pressure_gradient_pa_per_m`, and `published_friction.moreno_quiben_th3337_candidate_dryout_interpolated_pressure_gradient_pa_per_m` are pressure-drop guidance, not HTC. This does not release WUT Part I map transitions, WUT Part II stratified-wavy/dryout/mist HTC equations, project dryout prediction, CHF prediction, or hydrodynamic `critical_loads.py` coupling.
- Источник: Wojtan TH2978 rendered page 183 candidate transcription, corroborated by Moreno Quiben TH3337 p. 124 candidate transcription; target journal source remains Wojtan L., Ursenbacher T., Thome J. R. Investigation of flow boiling in horizontal tubes: Part II - Development of a new heat transfer model for stratified-wavy, dryout and mist flow regimes. International Journal of Heat and Mass Transfer, 2005, 48, 2970-2985, DOI `10.1016/j.ijheatmasstransfer.2004.12.013`; `docs/source_gate_manifest.json`; `docs/primary_source_inventory.md`.
- Код: candidate helpers `boiling_heat_transfer.wojtan_th2978_candidate_dryout_inception_quality`, `boiling_heat_transfer.wojtan_th2978_candidate_dryout_completion_quality`, `boiling_heat_transfer.wojtan_th2978_candidate_dryout_limits`, `boiling_heat_transfer.wojtan_th3337_candidate_dryout_inception_quality`, `boiling_heat_transfer.wojtan_th3337_candidate_dryout_completion_quality`, `boiling_heat_transfer.wojtan_th3337_candidate_dryout_boundaries`, and `published_friction.moreno_quiben_th3337_candidate_dryout_interpolated_pressure_gradient_pa_per_m`. Runtime `dryout_limit` remains `not_evaluated_source_required`.
- Тесты: `tests/test_boiling_diagnostics.py`; `tests/test_source_gate_manifest.py`.
